...
import com.which.freefish.mapper.BmsTagMapper;
...
import com.which.freefish.service.IBmsTagService;
...
public class IBmsPostServiceImpl extends ServiceImpl<BmsTopicMapper, BmsPost> implements IBmsPostService {
    ...
    @Autowired
    private com.which.freefish.service.IBmsTopicTagService IBmsTopicTagService;
    ...
    public Page<PostVO> searchByKey(String keyword, Page<PostVO> page) {
        ...
        if (StringUtils.isNotBlank(keyword)) {
            boolQueryBuilder.should(QueryBuilders.matchQuery("title", keyword).fuzziness(1))
                    .should(QueryBuilders.matchQuery("content", keyword).fuzziness(1))
